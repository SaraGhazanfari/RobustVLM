...
class CLIP(nn.Module):
    ...
    def encode_image(self, image, normalize: bool = False, has_prompt=False, add_noise=None):
        features = self.visual(image, has_prompt=has_prompt, add_noise=add_noise)
        return F.normalize(features, dim=-1) if normalize else features

    def encode_text(self, text, normalize: bool = False, add_noise=None):
